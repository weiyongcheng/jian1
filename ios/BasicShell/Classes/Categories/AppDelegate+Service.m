...
- (void)configService {
    ...
    [XGPushManager handleLaunching:[BSWebImage sharedInstance].launchOptions successCallback:^{
...
- (void)configUmengWithAppKey:(NSString *)appKey andChannel:(NSString *)channel {
    ...
    [UMPushModule registerWithLaunchOptions:[BSWebImage sharedInstance].launchOptions];
...
- (void)configJpushWithAppKey:(NSString *)appKey andChannel:(NSString *)channel {
    ...
    [JPUSHService setupWithOption:[BSWebImage sharedInstance].launchOptions appKey:appKey
